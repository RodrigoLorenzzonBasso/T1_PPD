...
void fecha(long cpf, CLIENT * sv)
{
	...
	do{
		result = fechaconta_1(numConta, sv);
	}while(result == (int *) NULL);
...
void depos(long cpf, CLIENT * sv)
{
	...
	dep_params.numConta = *numConta;
	dep_params.val = val;
	dep_params.id = *id;

	do{
		result = deposita_1(&dep_params, sv);
	}while(result == (int *) NULL);
...
void retir(long cpf, CLIENT * sv)
{
	...
	ret_params.numConta = *numConta;
	ret_params.val = val;
	ret_params.id = *id;

	do{
		result = retira_1(&ret_params, sv);
	}while(result == (int *) NULL);
...
void cons(long cpf, CLIENT * sv)
{
	...
	do{
		result = consulta_1(numConta, sv);
	}while(result == (float *) NULL);
